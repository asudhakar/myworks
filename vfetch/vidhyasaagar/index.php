    ...
    <div class="container">
      ...
      <?php 
        ...
        foreach ($final_output as $key => $value) {
          echo '<div><a href="view/dashboard.php?file_path='.$value.'">'.$value.'</a><form action="delete.php" method="get"><input type="hidden" name="id" value="'.$key.'"><input type="submit" class="btn btn-danger" style="font-size: 13px;"  value="delete"></form></div><br/>';
        }
